...
impl PaperMetadata {
    ...
    pub fn to_bibtex(&self) -> String {
        let authors = self.authors.join(" and ");
        let year = self.year().unwrap_or(0);
...
mod tests {
    ...
    fn create_test_metadata() -> PaperMetadata {
        ...
        metadata.authors = vec!["John Smith".to_string(), "Jane Doe".to_string()];
    ...
    fn test_to_bibtex() {
        ...
        assert!(bibtex.contains("author = {John Smith and Jane Doe}"));
