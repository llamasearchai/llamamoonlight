# Contributing to LlamaMoonlight

Thank you for your interest in contributing to LlamaMoonlight! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaMoonlight:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamamoonlight.git
   cd llamamoonlight
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamamoonlight.git
   ```
...
By contributing to LlamaMoonlight, you agree that your contributions will be licensed under the project's MIT License.
